  ...
  return (
    <section id='about' className='flex w-full flex-col items-center gap-16 px-30'>
      ...
      <div className='flex justify-around text-custom-white text-3xl'>
        ...
        <p className='w-2/5'>Besides, I'm an exchange student of PGM (Programa Ganhe o Mundo), which is responsible for taking me to Vancouver (Canada) in order to improve my <span className='text-custom-blue'>English skills</span>.</p>
      </div>
    </section>
  )
}
