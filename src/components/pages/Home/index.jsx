      ...
      <header role='banner' id='home' className="flex flex-col lg:flex-row lg:justify-around lg:items-center py-20 gap-24 lg:gap-0 lg:py-32 font-bold w-full items-center flex-wrap">
        <div className='flex flex-col gap-4 w-fit items-center lg:items-start'>
          ...
          <div className='flex flex-col lg:flex-row gap-8 justify-between items-center flex-wrap md:gap-8'>
            <a href='/#contact' aria-label='Click here to contact Wesllen in the contact area.' className='bg-custom-light-blue border-4 border-custom-light-blue text-custom-dark-blue text-3xl font-bold px-10 py-2 rounded-xl transition duration-400 hover:bg-custom-dark-blue hover:text-custom-light-blue'>
              Contact me
            </a>
            <a href={Resume} download aria-label="Click here to download Wesllen's résumé." className='border-custom-light-blue border-4 text-3xl text-custom-light-blue font-bold px-6 py-1 rounded-xl hover:bg-custom-light-blue hover:text-custom-dark-blue transition duration-400'>
              Download résumé
            </a>
          </div>
        </div>
